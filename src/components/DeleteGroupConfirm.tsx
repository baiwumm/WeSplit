    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">确认删除分账组？</h3>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
          <h4 className="text-sm font-medium text-red-800 dark:text-red-300 mb-2">即将删除的分账组：</h4>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
          <h4 className="text-sm font-medium text-yellow-800 dark:text-yellow-300 mb-2">删除后将丢失：</h4>
